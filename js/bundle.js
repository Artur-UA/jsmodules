...
function calc() {
  var kkal = document.querySelector('.calculating__result span');
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, title, descr, price, parentSelector) {
      ...
      this.src = src, this.alt = alt, this.title = title, this.descr = descr, this.price = price, this.classes = classes, this.parent = document.querySelector(parentSelector), this.changeUSD = 28, this.changeToUAH();
    }

    _createClass(MenuCard, [{
      key: "changeToUAH",
      value: function changeToUAH() {
        this.price = this.price * this.changeUSD;
      }
    }, {
      key: "render",
...
function forms(modalTimer) {
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["openModal"])("[data-modalWindow]", modalTimer);
    ...
    setTimeout(function () {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_8__["closeModal"])("[data-modalWindow]");
    }, 2000);
  }
}
...
function modal(btnSelector, modalSelector, modalTimer) {
  var btnModal = document.querySelectorAll(btnSelector),
...
function slider(_ref) {
  var container = _ref.container,
      ...
      sliderWindow = _ref.sliderWindow;
  var prevSlides = document.querySelector(prevArrow),
  ...
  if (slider.length < 10) {
    sliderTotal.textContent = "0".concat(slider.length);
    sliderNumber.textContent = "0".concat(sliderItem);
  } else {
  ...
  nextSlides.addEventListener('click', function () {
    ...
    slidesWindow.style.transform = "translateX(-".concat(offset, "px)");
...
function timer(id, deadline) {
  ...
  function setClock(timerSelector, endTime) {
    ...
    function updateClock() {
      ...
      if (t.total <= 0) {
        seconds.textContent = '00', minutes.textContent = '00', hours.textContent = '00', days.textContent = '00';
...
window.addEventListener("DOMContentLoaded", function () {
  var modalTimer = setTimeout(function () {
    return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["openModal"])("[data-modalWindow]", modalTimer);
  }, 50000);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])(".tabcontent", ".tabheader__items", ".tabheader__item", 'tabheader__item_active');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])("[data-modal]", "[data-modalWindow]", modalTimer);
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"])(modalTimer);
